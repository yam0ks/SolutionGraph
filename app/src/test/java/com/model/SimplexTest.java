...
public class SimplexTest extends TestCase {
    ...
    public void testGetResult() {
        ...
        restrictions[0] = new Restriction(new double[]{2, 12, 14}, 0, constants.Sign.LEQ, 349);
        restrictions[1] = new Restriction(new double[]{4, 12, 15}, 0, constants.Sign.LEQ, 264);
        restrictions[2] = new Restriction(new double[]{17, 17, 18}, 0, constants.Sign.LEQ, 337);
